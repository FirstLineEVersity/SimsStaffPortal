    ...
    private void displayNotificationDetails(){
        ...
        try {
            ...
            Cursor cursor = db.rawQuery("SELECT strftime('%d-%m-%Y %H:%M:%S', lastupdatedate) as lastupdated," +
                    ...
                    " group_concat(receivedfrom||'##'||notificationtitle||'##'||notificationtime||'##'||notificationmessage) as notificationdetails " +
        ...
        protected void onPostExecute(Void result){
            ...
            try {
                ...
                for (int i = 0; i <= temp.length() - 1; i++) {
                    ...
                    sc.insertNotificationDetails(lngEmployeeId,strNotificationDate ,object.getString("receivedfrom"),
